### exercise: ko array - add row to array of objects. The rows in the array contain objects with elements that are arrays. Each element needs to update row totals. 
